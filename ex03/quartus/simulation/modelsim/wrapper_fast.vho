...
-- LEDR[2]	=>  Location: PIN_J11,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
...
-- SW[2]	=>  Location: PIN_G12,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
...
-- Equation(s):
-- \dut|f~0_combout\ = (\SW~combout\(1)) # (!\SW~combout\(2))
