...
SIGNAL \dut|mux|Mux0~0_combout\ : std_logic;
...
\dut|mux|Mux0~0\ : cycloneii_lcell_comb
-- Equation(s):
-- \dut|mux|Mux0~0_combout\ = \SW~combout\(0) $ (\SW~combout\(2) $ (\SW~combout\(1)))
...
PORT MAP (
	...
	datac => \SW~combout\(2),
	datad => \SW~combout\(1),
	combout => \dut|mux|Mux0~0_combout\);
